# 소스 코드 출처 : https://github.com/kairess/geetest-captcha-cracker
# 일부 수정
...
BROWSER_MENU_HEIGHT = 170 # 높이 값이 고정이네, 해상도 따라 달라지니까 해상도값은 user-agent로 고정 시켜놓고 ㄱ
THRESHOLD = 100

os.makedirs('snaps', exist_ok=True)

s = Service('/Users/brad/Development/bdf_code/geetest-slider-captcha-cracker/chromedriver') # 이거 경로 MacOS 환경임. window로 바꿔주셈.
