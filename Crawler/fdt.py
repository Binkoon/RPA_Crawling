...
class FDT_Crawling(ParentsClass):
    ...
    def retry_failed_vessels(self, failed_vessels):
        ...
        self.logger.info(f"=== FDT 실패한 선박 재시도 시작 ===")
        ...
        # 재시도 결과 요약
        self.logger.info("="*60)
        self.logger.info("FDT 재시도 결과 요약")
        self.logger.info("="*60)
        ...
        return {
            ...
            'note': f'FDT 재시도 완료 - 성공: {retry_success_count}개, 실패: {retry_fail_count}개'
        }