...
#             result = try_run_carrier(carrier_name, None, crawling_results)
#             print(f"=== {carrier_name} 완료 ===")
#         except Exception as e:
#             print(f"=== {carrier_name} 실행 중 오류: {str(e)} ===")
